...
module QueryPatch
  ...
  module InstanceMethods
    ...
    def available_filters_with_patch
      ...
      @available_filters.delete("estimated_hours") if (!User.current.allowed_to_view_all_time_entries?(project) and !User.current.admin)
...
module IssueQueryPatch
  ...
  module InstanceMethods
    ...
    def available_columns_with_patch
      ...
      if (!User.current.allowed_to_view_all_time_entries?(project) and !User.current.admin)
